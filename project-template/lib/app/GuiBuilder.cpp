...
tgui::Label::Ptr WidgetCreator::createLabel(const std::string& text, unsigned fontSize) {
...
tgui::CheckBox::Ptr WidgetCreator::createCheckbox(bool checked, std::function<void(bool)> onChange) {
...
tgui::Slider::Ptr WidgetCreator::createSlider(float value, std::function<void(void)> onChange, float lo, float hi, float step) {
...
tgui::ComboBox::Ptr WidgetCreator::createDropdown(const std::vector<std::string>& items, const std::string& selected, std::function<void(void)> onSelect) {
